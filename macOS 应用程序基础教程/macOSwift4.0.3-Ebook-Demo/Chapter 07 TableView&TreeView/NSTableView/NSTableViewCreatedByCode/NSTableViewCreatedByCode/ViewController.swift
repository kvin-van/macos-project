...
extension ViewController: NSTableViewDelegate {
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        ...
        if view == nil {
            ...
            //线
            let lineBox : NSBox  = NSBox(frame: NSRect(x: 0, y: 0, width:200, height: 1))
            lineBox.layer?.backgroundColor =  NSColor.red.cgColor
            lineBox.boxType = .custom
            cellView.addSubview(lineBox)
            
//            let lineBoxLeftAnchor =  lineBox.leftAnchor.constraint(equalTo: cellView.leftAnchor, constant: 0)
//            let lineBoxRightAnchor = lineBox.rightAnchor.constraint(equalTo: cellView.rightAnchor, constant: 0)
//            let lineBoxWidthAnchor = lineBox.widthAnchor.constraint(equalTo: cellView.widthAnchor)
//            let lineBoxHeight = lineBox.heightAnchor.constraint(equalToConstant: 1.0)
//            NSLayoutConstraint.activate([lineBoxLeftAnchor, lineBoxRightAnchor,lineBoxWidthAnchor,lineBoxHeight])
        }
