...
//在使用Editor中的Create NSManagedObject Subclass 这个命令的时候，需要先把这个model的Codegen设置为Manual/None，否则会报错，在编译的时候
@NSApplicationMain
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    // MARK: - Core Data Saving and Undo support 核心数据保存和撤消支持
