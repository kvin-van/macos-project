...
final class CustomView: NSView {
    ...
    // MARK: Event
    override func mouseDown(with theEvent: NSEvent) {// 鼠标点击事件
    ...
    func drawViewShape(){
        ...
        let attrs = [NSAttributedString.Key.font : font! ,
                     NSAttributedString.Key.foregroundColor :NSColor.blue,NSAttributedString.Key.backgroundColor :NSColor.red]
    ...
    func saveScrollViewAsImage() {
        ...
        for i in 0..<count {
            ...
            //写死的文件路径
            let path = "/Users/wangbendong/Documents/myCapture.png"
