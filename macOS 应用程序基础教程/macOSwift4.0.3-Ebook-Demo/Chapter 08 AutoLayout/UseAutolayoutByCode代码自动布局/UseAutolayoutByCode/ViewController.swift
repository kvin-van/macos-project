...
//        self.addConstraintByAnchor()
    ...
    func addConstraintByAnchor() {
        ...
        let top = currentView.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 20)
        let bottom = currentView.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: 0)
        
        let left =  currentView.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: 15)
        let right = currentView.rightAnchor.constraint(equalTo: self.view.rightAnchor, constant: -2)
