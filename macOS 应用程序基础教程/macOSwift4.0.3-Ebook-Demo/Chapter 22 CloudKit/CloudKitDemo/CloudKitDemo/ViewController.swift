...
class ViewController: NSViewController {
    ...
    func insertRecord() {
        ...
        let recordID = CKRecord.ID(recordName: "1200")
    ...
    func insertLocationRecord() {
        let myContainer = CKContainer.default()
        let database = myContainer.privateCloudDatabase
        let recordID = CKRecord.ID(recordName: "121")
        let record = CKRecord(recordType: "Home", recordID: recordID)
        record["name" ]   = "MacKerricher117" as CKRecordValue?
        record["address"] = "Mei Chen117" as CKRecordValue?
    ...
    func deleteRecord() {
        let myContainer = CKContainer.default()
        let database = myContainer.privateCloudDatabase
        let recordID = CKRecord.ID(recordName: "120")
    ...
    func insertPictureRecord() {
        let myContainer = CKContainer.default()
        let database = myContainer.privateCloudDatabase
        let recordID = CKRecord.ID(recordName: "122")
        let record = CKRecord(recordType: "Home", recordID: recordID)
        record["name" ]   = "MacKerricher117" as CKRecordValue?
        record["address"] = "Mei Chen117" as CKRecordValue?
    ...
    func createReference() {
        ...
        let memberRecordID = CKRecord.ID(recordName: "122")
        ...
        let groupRecordID = CKRecord.ID(recordName: "Group222")
        ...
        let groupReference = CKRecord.Reference(record: groupRecord, action:.none)
        //建立group关联
    ...
    func fetchRecords() {
        ...
        let memberRecordID1 = CKRecord.ID(recordName: "1122")
        let memberRecordID2 = CKRecord.ID(recordName: "1133")
