...
class ViewController: NSViewController {
    ...
    func initiateControllers() {
        let vc1 = self.storyboard?.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier("FirstVC")) as! NSViewController
        let vc2 = self.storyboard?.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier("SecondVC")) as! NSViewController
        self.addChild(vc1)
        self.addChild(vc2)
    }
